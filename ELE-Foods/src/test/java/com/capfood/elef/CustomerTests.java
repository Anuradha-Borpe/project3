...
public class CustomerTests {
	 ...
	 */
	/*
	 * @Test public void test5() throws Exception{ CarryBox
	 * carryBox=service.getACarryBoxDetails("aar@gmail.com");
	 * 
	 * 
	 * //Initially checking the list of Items in the Carry Box assertEquals(0,
	 * carryBox.getItemlist().size());
	 * 
	 * 
	 ...
	 * 
	 * 
	 * //Adding items to the Carry Box assertEquals(true,
	 * service.addItemToCarryBox("aar@gmail.com", 2001)); assertEquals(true,
	 * service.addItemToCarryBox("aar@gmail.com", 2004)); //Inactive Item
	 * 
	 * 
	 * 
	 * //deleting the inactive item service.deleteACarryBoxItem("aar@gmail.com",
	 * 2004);
	 * 
	 * 
	 * //Throws exception when an order is placed to another city away from the
	 * branch assertThrows(OutOfLocationRangeException.class, ()->{
